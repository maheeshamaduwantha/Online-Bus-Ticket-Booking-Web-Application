<%@ Page Title="" Language="C#" MasterPageFile="~/BusBookingMaster.Master" AutoEventWireup="true" CodeBehind="PassengerDetailsInfo.aspx.cs" Inherits="SLTBweb.PassengerDetailsInfo" %>
        ...
        <asp:GridView ID="gdPassengerDetails" runat="server" ShowFooter="true" AutoGenerateColumns="false" Width="100%">
            ...
            <Columns>
                ...
                <asp:TemplateField>
                    ...
                    <FooterTemplate>
                        <asp:Button ID="ButtonAdd" runat="server" Style="background-color: red" Text="Add New Passanger Details"
                    ...
                    <div class="col-xs-6 col-sm-6 col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <asp:DropDownList ID="ddlBank" runat="server" class="form-control input-sm floatlabel">
                                ...
                                <asp:ListItem Value="1" Text="Bank Of Ceylon"></asp:ListItem>
                                <asp:ListItem Value="2" Text="Commercial Bank"></asp:ListItem>
                                <asp:ListItem Value="3" Text="Seylan Bank"></asp:ListItem>
                                <asp:ListItem Value="4" Text="DFCC Bank"></asp:ListItem>
                                <asp:ListItem Value="5" Text="People's Bank"></asp:ListItem>
                            </asp:DropDownList>
