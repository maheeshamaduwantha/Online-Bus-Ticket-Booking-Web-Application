<%@ Page Title="" Language="C#" MasterPageFile="~/BusBookingMaster.Master" AutoEventWireup="true" CodeBehind="SeatDetails.aspx.cs" Inherits="SLTBweb.SeatDetails" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container" style="margin-top:8%">
         <div class="panel-heading">
                    <div class="col-lg-8">
                        <h4 style="color: white;">Choose seats by clicking the corresponding seat in the layout below:</h4>
                    </div>
                ...
                <div class="panel-body">
                    <div class="col-lg-8">
                        <table runat="server">
                            <tr>
                                <td style="color:white;font-size:large">Front</td>
                                ...
                                <td style="color:white;font-size:large">Rear</td>
                            </tr>
                        </table>
           ...
           $('.' + settings.seatCss).click(function () {
               if ($(this).hasClass(settings.selectedSeatCss)) {
                   ...
                   if (str.length > 5) {
                       ...
                       alert('You cant select more than five seats per booking');
                   }
                   else {
